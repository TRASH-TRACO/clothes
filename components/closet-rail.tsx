 ...
 *
 * 화면 위 어딘가에 걸린 옷이 바람에 흔들린다. **손으로 좌우로 쓸면 지나는 길의 옷이
 * 차례로 밀렸다가 제자리로 돌아온다** — 손이 옷을 잡아 끄는 것이고, 한 벌씩 손에서
 * 미끄러진다 (흔들리는 계산은 lib/pendulum.ts, 돌리는 쪽은 components/rail-swing.tsx).
